...
<div class="container-fluid">  		 		
 ...
 <div class="form-group">                                     
          ...
          <input type="text" class="form-control" name="username" placeholder="Digite su contraseña">
                 </div>
                  <div class="form-group">                                     
          ...
          <input type="text" class="form-control" name="especialidaddocente" placeholder="Digite su especialidad o area de conocimiento">
                 ...
                 <div class="form-group" align="center">
                     <button class="btn btn-success" onclick="submit();" name="accion" value="crear">Ingresar</button>
                 </div>
 				</form>
 			</div>
 		</div>
